...
void catchCurveAndScreen(WCHAR *_imgpath, char *_rawPath, char *_depthPath, char *_matrixPath, char *_envDepth, bool _forceSave, bool _onlyScreen = false);
//void catchCurveAndScreen(WCHAR *_imgpath, char *_rawPath, char *_depthPath, char *_matrixPath, bool _forceSave, bool _onlyScreen = false);
